...
export default function MaisonLandingPage() {
  return (
    <div
      style={{ fontFamily: "Inter, sans-serif", backgroundColor: "#FAFAF8" }}
    >
      {/* Google Fonts */}
      <style>{`
      ...
      >
        ...
        >
          ...
          >
            Des propriétés d'exception sélectionnées par nos experts.
            Accompagnement personnalisé de la recherche à la signature.
          </p>
      ...
      >
        ...
        {[
          {
            title: "Acheter",
            links: ["Appartements", "Maisons", "Biens de prestige"],
          },
          {
            title: "Agence",
            links: ["Notre équipe", "Contact", "Mentions légales"],
          },
        ].map((col) => (
          <div
            key={col.title}
